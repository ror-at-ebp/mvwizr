...
mvwizr kann auch NAWA-MV-Daten einlesen - entweder mit `einlesen_nawa()` für einzelne Dateien oder mit `batch_einlesen_nawa()` für mehrere Dateien. Die NAWA-MV-Dateien sind in der Regel im Format `csv` (kommagetrennt) oder `xlsx` (Excel). Die Struktur ist dabei vorgegeben (definiert durch das BAFU), wobei die Spaltennamen auf Deutsch oder Französisch angegeben sein können. 
...
| Messwert                                   | Messwert (wird zu `WERT_NUM` umgewandelt). Falls <BG, dann markiert.                                                                                                                                                                                                                                            | `numeric`                        |
